...
namespace JI.DataStorageAccess.Infrastructure
{
    public class DependencyResolverPackage : IPackage
    {
        ...
        {
            container.Register(typeof(ITaskDeadlineStore), typeof(TaskDeadlineStore), Lifestyle.Scoped);
            container.Register(typeof(IFileStore), typeof(FileStore), Lifestyle.Scoped);
